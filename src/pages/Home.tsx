      ...
      <section className="relative bg-slate-950 overflow-hidden pt-20 pb-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative mt-10 lg:mt-0 w-full max-w-md sm:max-w-lg md:max-w-2xl mx-auto lg:max-w-none lg:mx-0">
              <div className="absolute inset-0 bg-gradient-to-tr from-primary-light to-accent rounded-2xl lg:rounded-3xl blur-3xl opacity-20"></div>
              <img
                src="/ai-platform-mockup-large.png"
                alt="Enterprise AI Platform Dashboard"
                className="relative w-full h-auto rounded-2xl lg:rounded-3xl shadow-2xl border border-white/10 transform hover:scale-105 transition-transform duration-500"

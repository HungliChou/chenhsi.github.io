export const siteContent = {
  ...
  faq: [
    { question: "宸希科技的 AI 服務合作流程是什麼？", answer: "我們先進行需求評估與數據審核，再擬定專屬方案。項目分為調研、開發、測試、部署等階段，全程透明溝通，並提供技術培訓與後續支援。" },
    { question: "導入一套完整的 AI 解決方案需要多長時間？", answer: "時程視專案規模與複雜度而定。小型專案約 1~2 個月完成（如部署問答系統），大型系統整合可能需 4~6 個月。我們會在評估階段提供大致排程與里程碑。" },
    { question: "AI 專案的投資回報期（ROI）如何計算？", answer: "通常我們會與客戶共同設定可量化指標，例如自動化節省人力成本、提升銷售轉換率等。實際 ROI 取決於改變規模與推廣範圍，許多客戶案例在 6~12 個月內即可看見明顯效益。" },
    { question: "是否提供私有化部署？企業資料如何保護？", answer: "提供私有化部屬選項，所有運算可在企業內部伺服器執行。平台通過 ISO27001 資安認證，並採用多重資料加密與存取控制，確保企業機密資料安全不外洩。" },
    { question: "服務價格如何計算？是一次性收費還是訂閱制？", answer: "依據專案範圍不同，我們可提供一次性開發+部署報價，或按年度訂閱制模式。訂閱服務包含持續更新與技術支援，更適合需要長期維運的企業。" },
    { question: "導入 AI 後，是否提供員工培訓與使用指導？", answer: "是的，我們提供完整的教育訓練與操作手冊。包括現場培訓、操作說明文件以及線上教學影片，確保客戶能充分掌握系統使用方法與最佳實踐。" },
    { question: "宸希科技是否有合作案例可參考？", answer: "有的，我們的「成功案例」頁面即展示多個行業實例。公開案例皆經客戶同意，若需更多詳細案例，歡迎聯絡業務或索取案例集。" },
    { question: "若企業已有部分 AI 能力，可否單獨擴充服務？", answer: "可以。我們可對接現有模型或平臺，優化其效果或加入新功能；也可提供 API 串接與模型調優建議，協助企業漸進式升級 AI 能力。" },
    { question: "支援哪些語言或地區市場？", answer: "我們目前以中文（繁體、簡體）服務為主，亦可支援英文。主要聚焦台灣市場，也服務大中華與其他國際客戶。將來可視需求擴展更多語系支持。" },
    { question: "AI 解決方案需要什麼軟硬體環境？", answer: "依方案不同有所差異。若為雲端部署，我們可在 AWS/Azure/GCP 等平台運行，客戶端只需配置訪問權限。若為私有化部署，可能需要具備GPU運算資源，我們會提供最低運算需求建議並協助導入。" }
  ],
  blog_posts: [
    {
